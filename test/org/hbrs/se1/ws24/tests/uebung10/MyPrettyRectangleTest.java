...
public class MyPrettyRectangleTest {
	 ...
	 * ob ein Rechteck
	 * ein anderes Rechteck vollstaendig enthaelt. Bitte geben Sie einen
	 * vollständigen Test an!
	...
	public void testGetArea() {
		...
		// actual values.
		// Weitere Infos:
		// http://stackoverflow.com/questions/7554281/junit-assertions-make-the-assertion-between-float
	...
	public void testGetBoundingBox() {
		...
		BoundingBoxFactory boundingBoxFactory = new BoundingBoxFactory();
		assertTrue(new MyPrettyRectangle(1.0, 0.0, 6.0, 4.0).equals(boundingBoxFactory.create(rect)));

		// Testen sie zudem, ob ueberhaupt ein Objekt zurueckgegeben wird,
		// d.h. der Rueckgabe-Wert ungleich NULL ist
		//
		// [ihr Code]
		assertNotNull(boundingBoxFactory.create(rect));
		// Test, ob ein leeres Array ein "Null-Rectangle" (vier mal die Koordinaten 0)
		// zurueckliefert:
		//
		// [ihr Code]
		MyPrettyRectangle[] nothing = {};
		assertTrue(new MyPrettyRectangle(0, 0, 0, 0).equals(boundingBoxFactory.create(nothing)));
		// Test, ob die Übergabe eines NULL-Werts erfolgreich abgefangen wurde
		// (Rueckgabe == NULL!)
		//
		// [ihr Code]
		assertNull(boundingBoxFactory.create(null));
